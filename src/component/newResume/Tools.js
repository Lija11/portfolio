...
const Tools = () => {
  return (
    <div
      ...
      className="skill-container aos-init aos-animate m-auto"
    >
      <h2>Tools</h2>
      <div className="flex flex-wrap justify-center gap-5 pb-5">
        ...
        <div className="heroku">
          <ResumeIcon reactIcon={<GrHeroku />} text="Heroku" />
        </div>
        <div className="github">
          <ResumeIcon icon="fa-brands fa-github" text="Github" />
        </div>
        <div className="vsCode">
          <ResumeIcon reactIcon={<TbBrandVscode />} text="Vs Code" />
        </div>
        <div className="git">
          <ResumeIcon icon="fa-brands fa-git-alt" text="Git" />
        </div>
        <div className="netlify">
          <ResumeIcon reactIcon={<SiNetlify />} text="Netlify" />
        </div>
        <div className="dev">
          <ResumeIcon icon="fa-brands fa-chrome" text="Dev Tool" />
        </div>
        <div className="figma">
          <ResumeIcon reactIcon={<IoLogoFigma />} text="Figma" />
        </div>
      </div>
    </div>
  );
